function show() {
    var p2 = document.getElementById('para2'); //p2 is the element whose id is para2
    var p3 = document.getElementById('para3'); //p3 is the element whose id is para3
    if (p2.style.display == 'block') { //if p2 is showed 
        p2.style.display = 'none'; //we hide p2
        p3.innerHTML = 'SHOW ALL'; //and change p3 to SHOW ALL
    } else { //if p2 is hidden
        p2.style.display = 'block'; //we show p2
        p3.innerHTML = 'SHOW LESS'; //and change p3 to SHOW LESS
    }
}
